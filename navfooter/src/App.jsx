        ...
        <nav className="bg-white shadow-md">
            <div className="flex items-center justify-between p-3 nav-container">
              <div className="flex items-center">
                <a className="font-bold text-2xl text-violet-500	hover:text-violet-700" href="#">T M S</a>
                <div className="text-violet-700 ml-4 text-lg brand-name">Transport Management</div>
              </div>
